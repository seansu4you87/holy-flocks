...
public class BouncingSmiley extends BouncingBall
{
     ...
     */
    public BouncingSmiley (PointD center,
                           Dimension size,
                           PointD velocity,
                           Color color,
                           int trailSize)
    ...
    public void paint (Graphics pen)
    {
        ...
        // left eye
        pen.fillOval((int) (myCenter.x - mySize.width / 8 - mySize.width / 20),
                     (int) (myCenter.y - mySize.height / 8 - mySize.height / 10),
        ...
        pen.fillOval((int) (myCenter.x + mySize.width / 8 - mySize.width / 20),
                     ...
                     mySize.width / 10, mySize.height / 5);
        // smile!
        pen.drawArc((int) (myCenter.x - 11 * mySize.width / 40),
                    (int) (myCenter.y + mySize.height / 20 - 11 * mySize.height / 40),
